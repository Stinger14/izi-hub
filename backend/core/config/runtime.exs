...
config :core, CoreWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]

if config_env() == :dev do
  database_url =
    System.get_env("DATABASE_URL") || "ecto://postgres:izihubpassword@localhost:5432/izi-hub-db"
  ...
  secret_key_base =
    System.get_env("SECRET_KEY_BASE") ||
      "e3tmKnn5Y0wtSpyIiAPoeQzG5f4yZ7336cChXyyME4YtIigGDP0t6AX6fuHwNWMp"
